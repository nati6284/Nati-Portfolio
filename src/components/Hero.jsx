    ...
    >
      <div className="container mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 mb-10 md:mb:0">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Hi, I'm <span className="text-blue">Natnael Abera</span>
          </h1>
          <h2 className="text-2xl md:text-4xl font-semibold mb-6 typewriter">
            Full Stack Developer
          </h2>
          <p className="text-lg text-gray-300 mb-8">
            I have experience in developing software with React and Spring-boot{" "}
          </p>
      ...
      <div className="md:w-1/2 flex justify-center">
        <div className="relative w-64 h-64 md:w-80 md:h-80">
          <div className="basolute insert-0 rounded-full bg-gradient-to-r from-blue to-blue-light  opacity-70">
            <motion.img
              animate={{ y: [0, -20, 0] }}
              transition={{
                duration: 4,
